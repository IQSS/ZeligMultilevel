...
\title{Zelig for Multilevel Regressions}
...
%\VignetteIndexEntry{Multilevel Regressions for Zelig}
%\VignettePackage{ZeligMultilevel}
%\VignetteDepends{ZeligMultilevel}
%\VignetteKeyWords{mixed, multilevel, regressions, zelig}
...
\subsection*{How to Cite the Multi-level Gamma Model}
\bibentry{ImaLauKin-gamma.mixed11}
...
\subsection*{How to Cite the Multi-level Least Squares Model}
\bibentry{ImaLauKin-ls.mixed11}
...
\subsection*{How to Cite the Multi-level Poisson Model}
\bibentry{ImaLauKin-poisson.mixed11}
